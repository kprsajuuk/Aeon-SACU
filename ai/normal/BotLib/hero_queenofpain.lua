...
function X.ConsiderR()
	...
	local nRadius = abilityR:GetSpecialValueInt( 'final_aoe' ) * 0.72
	...
	then
		local locationAoEHurt = bot:FindAoELocation( true, false, bot:GetLocation(), nCastRange - 150 , nRadius + 50 , 0, 0 )
		if locationAoEHurt.count >= 12
		then
